    ...
    <div class="col-lg-6 fixed-height-100 d-flex align-items-center"> 
      <div class="d-flex flex-column w-100 px-2">   
        ...
        <div class="h3 display-6 text-center">
          <span class="text-success">Welcome</span> Voter,
        </div>
        <span class="lead text-success text-center">please login to your account, to continue voting.</span>
          ...
          <?= form_open('signin');?>
            ...
            <div class="row justify-content-between g-2">
              <div class="col-auto order-2 order-sm-1">
                <a href="<?= site_url()?>signup" class="link-primary text-decoration-none">Don't Have Account? Sign Up</a>
              </div>
